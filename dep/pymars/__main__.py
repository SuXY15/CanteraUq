...
parser.add_argument('-t', '--thresh',
                    help='Threshold value for DRG, instead of self adapting.',
                    type=float,
                    )
...
print(args.targets,args.retained_species)
...
if args.convert:
    ...
    if splitext(args.model)[1] in ['.inp', '.dat', '.txt']:
        ...
        args.model = convert(args.model, args.thermo, args.transport)

    pymars(args.model, args.conditions, args.error, args.method, args.targets, args.thresh,
