...
def write(solution):
    ...
    def build_arrhenius(equation_object, equation_type, equation_factor=1.0):
        """
        ...
        pre_exponential_factor = equation_object.rate.pre_exponential_factor*equation_factor
    ...
    def build_modified_arrhenius(equation_object, t_range, equation_factor=1.0):
        """
        ...
        if t_range == 'high':
            pre_exponential_factor = equation_object.high_rate.pre_exponential_factor*equation_factor
            ...
            activation_energy = (equation_object.high_rate.activation_energy /
                                calories_constant)
            if sum(equation_object.products.values()) == 1:
                pre_exponential_factor = str(
                                '{:.5E}'.format(pre_exponential_factor*10**3))
            else:
                pre_exponential_factor = str(
    ...
    for eq_index in range(len(trimmed_solution.reaction_equations())):
        ...
        equation_factor = trimmed_solution.multiplier(eq_index)
        print(equation_factor)
        ...
        if equation_type == 'ThreeBodyReaction':
            ...
            arrhenius = build_arrhenius(equation_object, equation_type, equation_factor)
            replace_list_2 = {"{":  "\"",
                              "\'": "",
                              ": ": ":",
                              ",":  " ",
        ...
        if equation_type == 'FalloffReaction':
            ...
            kf = build_modified_arrhenius(equation_object, 'high', equation_factor)
            kf0 = build_modified_arrhenius(equation_object, 'low', equation_factor)
            replace_list_2 = {
                            "{":"\"",
                            "\'":"",
                            ": ":":",
