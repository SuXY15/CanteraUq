...
class Simulation(object):
    ...
    def __init__(self, idx, properties, model, path='data/tmp/'):
    ...
    def run_case(self, stop_at_ignition=False, restart=False):
        ...
        table_def = {'time': tables.Float64Col(pos=0),
                     ...
                     'rate_progress': tables.Float64Col(
                          shape=(self.reac.thermo.n_reactions), pos=4
                          ),
                     }
        ...
        with tables.open_file(self.save_file, mode='w',
            ...
            timestep['rate_progress'] = self.gas.net_rates_of_progress
    ...
    def process_results(self):
        ...
        with tables.open_file(self.save_file, 'r') as h5file:
            ...
            rate_progress = table.col('rate_progress')
        ...
        for temperature, pressure, mass_fraction,rate_progress in \
            zip(temperatures, pressures, mass_fractions,rate_progress):
            ...
            if temperature >= temperature_initial + (multiplier * delta):
                ...
                point_data.append(rate_progress)
